...
class Filter_snp(Step):
    ...
    def get_count_array(record):
        ...
        for sample in record.samples:
            ...
            #print('---')
            ref_count_array.append(ref_count)  #ref_count_array.append(ad[0])
            alt_count_array.append(alt_count)  #alt_count_array.append(ad[1])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--subparser_assay", help="subparser_assay")

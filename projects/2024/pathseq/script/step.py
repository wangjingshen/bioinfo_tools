...
class Step:
    ...
    def __init__(self, args, display_title=None):
        ...
        #self.assay = args.assay  # args.subparser_assay
        ...
        for slot in self.__slots:
            self._path_dict[slot] = f'.{slot}.json'  # self._path_dict[slot] = f'{self.outdir}/../.{slot}.json'
        ...
        #    loader=FileSystemLoader(f'{self.assets_dir}/templates/'),
        #    autoescape=select_autoescape(['html', 'xml'])
        #)

        # out file
        self.__stat_file = f'{self.sample}_stat.txt'   # self.__stat_file = f'{self.outdir}/stat.txt'

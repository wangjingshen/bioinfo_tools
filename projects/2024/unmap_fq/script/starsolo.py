...
from __init__ import HELP_DICT, PATTERN_DICT, FILTERED_MATRIX_DIR_SUFFIX, COUNTS_FILE_NAME 
from step import Step, s_common
from barcode import Chemistry, Barcode
import utils
from make_ref import MakeRef
from matrix import CountMatrix
from emptydrop_cr import get_plot_elements
from cells import Cells_metrics
...
if __name__ == '__main__':
    ...
    parser.add_argument('--subparser_assay', help='subparser_assay.', required=True)

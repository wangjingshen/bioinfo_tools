...
class R3_to_R1_r():
    ...
    def run_cmd(self):
        cmd = (
            f'python /SGRNJ06/randd/USER/wangjingshen/script/ATAC_seq/R3_to_R1.py '
...
def run_single(fastq_path, prefix):
    runner = R3_to_R1_r(fastq_path, prefix)
    runner.run()
...
def main():
    ...
    new_mapfile['fastq_path'] = "_tmp/" + new_mapfile['prefix']+ "_replace"

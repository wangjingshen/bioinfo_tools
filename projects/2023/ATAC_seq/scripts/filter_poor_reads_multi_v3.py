...
class Filter_poor_reads_multi():
    ...
    def run_cmd(self):
        cmd = (
            f'python /SGRNJ06/randd/USER/wangjingshen/script/ATAC_seq/filter_poor_reads_v3.py '
...
def run_single(fastq_path, prefix):
    runner = Filter_poor_reads_multi(fastq_path, prefix)
    runner.run()

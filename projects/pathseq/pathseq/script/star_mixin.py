...
import utils
from make_ref import MakeRef
from step import Step,s_common
from __init__ import HELP_DICT
from __init__ import STAR_BAM_SUFFIX
...
if __name__ == '__main__':
    ...
    parser.add_argument('--outFilterMatchNmin',help="""Alignment will be output only if the number of matched bases 
                                                       is higher than or equal to this value.""", default=50, )
    parser.add_argument('--out_unmapped', help='Output unmapped reads.', action='store_true' )
    ...
    parser.add_argument('--starMem', help='Default `30`. Maximum memory that STAR can use.', default=30 )
    ...
    with Star_mixin(args, display_title='Mapping') as runner:
        runner.run()